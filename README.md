...
| Range | Status | Link |
|--------|--------|------|
| 0001 – 0500 | in progress | *(to be populated)* |
| 0501 – 1000 | in progress | *(to be populated)* |
| 1001 – 1500 | in progress | *(to be populated)* |
| 1501 – 2000 | in progress | *(to be populated)* |
| 2001 – 2500 | in progress | *(to be populated)* |
| 2501 – 3000 | in progress | *(to be populated)* |

### Completed Problems

| # | Title | Difficulty | Category | Solution |
|---|--------|------------|----------|---------|
| 1351 | Count Negative Numbers in a Sorted Matrix | Easy | Array / Binary Search / Matrix | [View](./1351.%20Count%20Negative%20Numbers%20in%20a%20Sorted%20Matrix/) |
